          ...
          <div class="modal-dialog modal-full">
            <div class="modal-content">
              <div class="modal-header">
                <a href="<?php echo base_url('admin/laporan');?>"><button type="button" class="close" data-dismiss="modal">&times;</button></a>
              ...
              <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <a href="<?php echo base_url('admin/laporan');?>"><button class="btn btn-info waves-effect waves-light pull-right" >Back</button></a>
                    </div>
                </div> <!-- row -->
              </div> <!-- body model-->
            </div> <!-- /.modal-content -->
