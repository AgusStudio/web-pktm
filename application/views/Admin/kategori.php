                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title text-center">Daftar Kategori <span><i class="fa fa-plus-square pull-right" data-toggle="modal" data-target="#AddModal" style="cursor: pointer"> Tambah Kategori</i></span></h3>
                                </div>
