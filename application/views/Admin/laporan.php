						...
						<div class="col-md-12">
							<div class="panel panel-info">
								...
								<div class="panel-body">
									<form name="FormEdit" class="form-horizontal" action="<?php echo site_url('admin/laporan');?>" method="POST">
									<div class="row">
										<div class="col-sm-4">
											<div class="row">
                        			...
                        			<table class="table table-striped table-bordered">
			                            ...
			                            <tbody>
			                                ...
			                                <tr>
			                                    ...
			                                    <td rowspan="<?php echo $row_span;?>"><?php echo $report->rt;?></td>
			                                    <td rowspan="<?php echo $row_span;?>"><?php echo $report->rw;?></td>
						...
						<div class="col-md-12">
							<div class="hidden-print">
                                <div class="pull-right">
                                    <form name="download" action="<?php echo site_url('admin/download');?>" method="POST">
